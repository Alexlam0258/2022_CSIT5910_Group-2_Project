...
for epoch in range(Epochs):
    ...
    if eval_loss<best_val_loss:
        ...
        print('Saving Model')
        torch.save(txtmodel, 'Text_Model_ResNet18.pt')
        torch.save(imgmodel, 'Image_Model_ResNet18.pt')
...
running_result = 'result_ResNet18.dat'
...
dictionary = {'Name' : 'Resnet18', 'Tloss':train_losses, 'Eloss':eval_losses, 'Critieria': Classifier, 'Result': result}
...
x = [num for num in range(1, len(tlosses)+1)]
