...
for epoch in range(Epochs):
    ...
    if eval_loss<best_val_loss:
        ...
        print('Saving Model')
        torch.save(txtmodel, 'Text_Model_OwnCNN.pt')
        torch.save(imgmodel, 'Image_Model_OwnCNN.pt')
...
running_result = 'result_OwnCNN.dat'
...
dictionary = {'Name' : 'CNN', 'Tloss':train_losses, 'Eloss':eval_losses, 'Critieria': Classifier, 'Result': result}
...
plt.title('Training Progress Diagram (OwnCNN) Model')
plt.savefig('OwnCNN.png')
plt.show()
plt.close()
